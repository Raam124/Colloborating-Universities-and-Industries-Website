...
String sql ="select Research_Id,Title,U_Date,Problem from Research_Problem";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
	Research rsh = new Research();
	rsh.setId(Integer.parseInt(resultSet.getString("Research_Id")));
	rsh.setTitle(resultSet.getString("Title"));
	
	SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy");
	
	//rsh.setDate(format.parse(resultSet.getString("U_Date")));
	rsh.setProblem(resultSet.getString("Problem"));
%>
<div class="one_third">
               <h4><%=rsh.getTitle()%></h4>
           <br/>
      <h4><%=resultSet.getString("U_Date")%></h4>
      <br/>
       <h4><%=rsh.getId()%></h4>
      <br/>
      </div>
