        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form  action="xyz9" method="POST" class="register-form" id="register-form">
                        <h2>student idea form</h2>
                        <div class="form-row">
                           
                        </div>
                        <div class="form-group">
                            <label for="sid">Research Id:</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-select">
                                    <select name="txtCom" id="txtCom">
                                        <option value=""></option>
                                        <option value="SISCO">SISCO Lab</option>
