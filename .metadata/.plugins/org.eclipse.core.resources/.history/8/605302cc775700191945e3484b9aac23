...
<div class="container portfolio">
  <div class="one_third shadow">
    <div class="view view-first"> <img src="syd6.jpg" alt="" width="300px" height="160px" />
      <div class="mask">
  ...
  <!--end one_third-->
  <div class="one_third shadow">
    <div class="view view-first"> <img src="b.jpg" alt="" />
      <div class="mask">
  ...
  <div class="one_third lastcolumn shadow">
    <div class="view view-first"> <img src="c.jpg" alt="" />
      <div class="mask">
  ...
  <!--end one_third-->
  <div class="one_third lastcolumn shadow">
    <div class="view view-first"> <img src="a.jpg" alt="" />
      <div class="mask">
        <h2><a href="#">Creative Software</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
