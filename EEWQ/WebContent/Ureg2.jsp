...
<div class="container portfolio">
  <div class="one_third shadow">
    <div class="view view-first"> <img src="WS02.png" alt="" width="300px" height="160px" />
      <div class="mask">
        <h2><a href="Research.jsp">WSO2</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third shadow">
    <div class="view view-first"> <img src="sys.png" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="Research.jsp">Sysco Labs</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <div class="one_third lastcolumn shadow">
    <div class="view view-first"> <img src="99x.png" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="Research.jsp">99x Technology</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third shadow">
    <div class="view view-first"> <img src="pear.png" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="Research.jsp">Pearson</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third shadow">
    <div class="view view-first"><img src="ifs.jpg" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="#">IFS</a></h2>
      </div>
      <!-- mask ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third lastcolumn shadow">
    <div class="view view-first"> <img src="oracle.jpg" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="#">Oracle</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <div class="one_third shadow">
    <div class="view view-first"> <img src="enbala.png" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="#">Enbala</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third shadow">
    <div class="view view-first"> <img src="micro.png" alt="" width="300px" height="160px"/>
      <div class="mask">
        <h2><a href="#">Microsoft</a></h2>
      </div>
      <!-- mask ends here --> 
    </div>
    <!-- view ends here --> 
  ...
  <!--end one_third-->
  <div class="one_third lastcolumn shadow">
    <div class="view view-first"> <img src="goog.png" alt="" width="300px" height="160px"/>
      <div class="mask">
